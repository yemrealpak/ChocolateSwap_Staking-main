...
import ERC20_CUSTOM from '../config/abi/erc20_custom.json'
...
export function useTokenContractCustom(tokenAddress, withSignerIfPossible) {
  return useContract(tokenAddress,ERC20_CUSTOM, withSignerIfPossible)
}
