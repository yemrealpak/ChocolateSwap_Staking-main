...
import { StyledSquadHeaderContainer } from 'views/PancakeSquad/components/Header/styles'
...
const Pools: React.FC = () => {
  ...
  chosenPools = chosenPools.filter((to) => to.sousId !== 0)
  ...
  const cardLayout = (
    <CardLayout>
      {chosenPools.map((pool) => (pool.vaultKey ? null : <PoolCard key={pool.sousId} pool={pool} account={account} />))}
    </CardLayout>
  )
    ...
    <>
        ...
        <PageHeader style={{ width: '100%' }}>
          <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
            <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
              <HeaderContainer>
                <img src="/images/ChocolateSwapLogo.png" alt="ChocolateSwap" style={{height:"200px"}} />
                <Heading ml="00px" as="h1" scale="xl" color="#6A2214">
                  {t('Staking Pools')}
                </Heading>
              </HeaderContainer>
            </Flex>
      ...
      <Page>
        ...
        <PoolControls>
          ...
          {/* <FilterContainer>
            <LabelWrapper>
              <Text fontSize="12px" bold color="silver" textTransform="uppercase">
                {t('Sort by')}
              </Text>
              <ControlStretch>
                <Select
